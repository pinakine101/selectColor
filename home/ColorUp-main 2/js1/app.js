...
// sliceColor(color1);
    ...
    function actCalcCouPlus(){ // запускаем перебор гаммы в *+* режима  *span.active*
		...
		colorCorrect(newArrHue, arraySaturGost,  newArrLight)
		console.log('privet')
...
// // 
	...
	if(tabsContent[0].getAttribute('id') == 'sleepRoom'){
		colorCorrect( arrayHueSleep, arraySaturSleep, arrayLightSleep, calcGamma) };	
	...
	function separateGamms (){
		...
		if(tabsBtn[0].classList.contains('active')){
			colorCorrect( arrayHueSleep, arraySaturSleep,  arrayLightSleep, calcGamma)
				...
				colorCorrect(arrayHueGost, arraySaturGost,  arrayLight)
					}
			else if(tabsBtn[2].classList.contains('active')){
				colorCorrect(arrayHueKitch, arraySaturKitch,  arrayLight)
				}
			else if(tabsBtn[3].classList.contains('active')){
				colorCorrect(arrayHueKids, arraySaturKids,  arrayLightKids)
				}
			else if(tabsBtn[4].classList.contains('active')){
				colorCorrect(arrayHueCab, arraySaturCab, arrayLightCab)
				}
			else if(tabsBtn[5].classList.contains('active')){
				colorCorrect(arrayHueHoll, arraySaturHoll, arrayLightHoll)
				}
			else if(tabsBtn[6].classList.contains('active')){
				colorCorrect(arrayHueHoll, arraySaturHoll, arrayLightCab)
					}
	};	
	...
	function colorCorrect(gammaHue, gammaSat, gammaLight, callback ) {
